            ...
            return (
              ...
              >
                <div className="flex flex-col items-center">
                  <div className="w-16 h-16 bg-[#D4A5A5] rounded-full flex items-center justify-center text-white text-2xl flex-shrink-0">
                    <Icon />
                  </div>
                  {index < content.events.length - 1 && (
                    <div className="w-1 flex-grow bg-[#D4A5A5] mt-2"></div>
                  )}
                </div>
                <div className="flex-grow pb-8">
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    <p className="text-[#B8860B] font-semibold mb-2">{event.time}</p>
